...
export const translations = {
  en: {
    ...
    pitchPressureTitle: 'Where the game is',
    pitchPressureSub: 'Territory from live match stats',
  ...
  ar: {
    ...
    pitchPressureTitle: 'فين كاينة اللعبة',
    pitchPressureSub: 'من إحصائيات الماتش دابا',
